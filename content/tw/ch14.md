...
在本書的最後一章，讓我們退後一步。全書至此，我們考察了形形色色的資料系統架構，權衡了它們的利弊，也探討了構建可靠、可擴展、可維護應用的技術。然而，我們一直略過了討論中一個重要而根本的部分，現在該把它補上了。
...
- 在 [第 2 章](/tw/ch2#ch_nonfunctional) 中，我們介紹了如何定義效能、可靠性、可擴展性和可維護性等非功能性需求。
...
- 在 [第 13 章](/tw/ch13#ch_philosophy) 中，我們探討了一套流式系統的哲學，使彼此不同的資料系統更容易整合、系統更容易演化，應用也更容易擴展。
