...
多租戶可以提高硬體利用率，更容易實現可擴展性，也便於雲服務商管理；但要保證一個客戶的活動不影響其他客戶的效能或安全，就必須經過周密的工程設計 [^33]。
...
可擴展性
:   如果資料量或計算需求增長到單臺機器無力承擔，或許可以把負載分散到多臺機器上。參見[“可擴展性”](/tw/ch2#sec_introduction_scalability)。
