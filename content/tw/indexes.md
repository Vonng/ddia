...
- B樹（指數）, [B 樹](/tw/ch4#sec_storage_b_trees)-[B 樹變體](/tw/ch4#b-tree-variants)
  ...
  - 與硬分裂相似, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)
...
- 協作編輯, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps)
...
- consent (GDPR), [同意與選擇自由](/tw/ch14#id375)
...
- 正確性
  ...
  - 個人資料, [責任與問責](/tw/ch14#id371), [隱私與資料使用](/tw/ch14#id457)
...
- 資料系統
  ...
  - 可維護性, [可維護性](/tw/ch2#sec_introduction_maintainability)-[可演化性：讓變化更容易](/tw/ch2#sec_introduction_evolvability)
  ...
  - 可擴展性, [可擴展性](/tw/ch2#sec_introduction_scalability)-[可擴展性原則](/tw/ch2#id35)
...
- 道德操守, [做正確的事情](/tw/ch14)-[立法與自律](/tw/ch14#sec_future_legislation)
  ...
  - 立法和自律, [立法與自律](/tw/ch14#sec_future_legislation)
  - 預測分析, [預測分析](/tw/ch14#id369)-[反饋迴路](/tw/ch14#id372)
    - 擴大偏見, [偏見與歧視](/tw/ch14#id370)
    - 反饋迴圈, [反饋迴路](/tw/ch14#id372)
  - 隱私和跟蹤, [隱私與追蹤](/tw/ch14#id373)-[立法與自律](/tw/ch14#sec_future_legislation)
    - 同意和選擇自由, [同意與選擇自由](/tw/ch14#id375)
    - 資料作為資產和權力, [資料作為資產與權力](/tw/ch14#id376)
    - 隱私的含義, [隱私與資料使用](/tw/ch14#id457)
    - 監視, [監視](/tw/ch14#id374)
...
- Figma （圖形軟體）, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps)
...
- 垃圾收集
  ...
  - 程序暫停, [延遲與響應時間](/tw/ch2#id23), [程序暫停](/tw/ch9#sec_distributed_clocks_pauses)-[限制垃圾回收的影響](/tw/ch9#sec_distributed_gc_impact), [多數派原則](/tw/ch9#sec_distributed_majority)
    - （另見 process pauses）
- 加油站演算法定價, [反饋迴路](/tw/ch14#id372)
- GDPR (regulation), [資料系統、法律與社會](/tw/ch1#sec_introduction_compliance), [不變性的侷限性](/tw/ch12#sec_stream_immutability_limitations)
  - 同意書, [同意與選擇自由](/tw/ch14#id375)
  - 資料最小化, [立法與自律](/tw/ch14#sec_future_legislation)
  - 合法權益, [同意與選擇自由](/tw/ch14#id375)
...
- Git（版本控制系統）, [併發控制](/tw/ch12#sec_stream_concurrency)
  - 本地第一軟體, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps)
...
- 谷歌
  ...
  - 資料流（流處理器）, [流分析](/tw/ch12#id318), [原子提交再現](/tw/ch12#sec_stream_atomic_commit), [統一批處理和流處理](/tw/ch13#id338)
    - （另見 Beam）
  - 資料流（變化資料捕獲）, [變更流的 API 支援](/tw/ch12#sec_stream_change_api)
  - Docs（協作編輯）, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps), [CRDT 與操作變換](/tw/ch6#sec_replication_crdts)
  ...
  - 響應時間研究, [平均值、中位數與百分位點](/tw/ch2#id24)
  - 工作表（協作電子表格）, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps), [CRDT 與操作變換](/tw/ch6#sec_replication_crdts)
...
- 治理, [超越資料湖](/tw/ch1#beyond-the-data-lake)
- 政府對資料的使用, [資料作為資產與權力](/tw/ch14#id376)
...
- Industrial Revolution, [回顧工業革命](/tw/ch14#id377)
...
- 分類賬（會計）, [總結](/tw/ch3#summary)
  - 不可改變性, [不可變事件的優點](/tw/ch12#sec_stream_immutability_pros)
- 遺留系統,維護, [可維護性](/tw/ch2#sec_introduction_maintainability)
- 法律事項, [資料系統、法律與社會](/tw/ch1#sec_introduction_compliance)-[資料系統、法律與社會](/tw/ch1#sec_introduction_compliance)
  ...
  - 隱私監管, [資料系統、法律與社會](/tw/ch1#sec_introduction_compliance), [立法與自律](/tw/ch14#sec_future_legislation)
- legitimate interest (GDPR), [同意與選擇自由](/tw/ch14#id375)
...
- 線性（專案管理軟體）, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps)
...
- 萬金油, [可擴展性原則](/tw/ch2#id35)
- 可維護性, [可維護性](/tw/ch2#sec_introduction_maintainability)-[可演化性：讓變化更容易](/tw/ch2#sec_introduction_evolvability), [流式系統的哲學](/tw/ch13#ch_philosophy)
  - 可演化性（見 可演化性）
...
- MongoDB（資料庫）
  ...
  - 請求路由, [請求路由](/tw/ch7#sec_sharding_routing)
  - 二級指數, [本地二級索引](/tw/ch7#id166)
  - 硬分裂, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)
...
- 離線系統, [批處理](/tw/ch11#ch_batch)
  - （另見 batch processing）
- 離線第一應用程式, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps), [有狀態、可離線的客戶端](/tw/ch13#id347)
- 頁:1
...
- 預彙總, [分析（Analytics）](/tw/ch11#sec_batch_olap)
  - 服務衍生資料, [對外提供派生資料](/tw/ch11#sec_batch_serving_derived)
- 分享前, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)
- Precision Time Protocol (PTP), [時鐘同步和準確性](/tw/ch9#sec_distributed_clock_accuracy)
- 上游鎖定, [謂詞鎖](/tw/ch8#predicate-locks)
- 預測分析, [分析型與事務型系統](/tw/ch1#sec_introduction_analytics), [預測分析](/tw/ch14#id369)-[反饋迴路](/tw/ch14#id372)
  - 擴大偏見, [偏見與歧視](/tw/ch14#id370)
  - ethics of（見 ethics）
  - 反饋迴圈, [反饋迴路](/tw/ch14#id372)
...
- 隱私, [隱私與追蹤](/tw/ch14#id373)-[立法與自律](/tw/ch14#sec_future_legislation)
  - 同意和選擇自由, [同意與選擇自由](/tw/ch14#id375)
  - 資料作為資產和權力, [資料作為資產與權力](/tw/ch14#id376)
  - 刪除資料, [不變性的侷限性](/tw/ch12#sec_stream_immutability_limitations)
  - ethical considerations（見 ethics）
  - 立法和自律, [立法與自律](/tw/ch14#sec_future_legislation)
  - 含義, [隱私與資料使用](/tw/ch14#id457)
  - 條例, [資料系統、法律與社會](/tw/ch1#sec_introduction_compliance)
  - 監視, [監視](/tw/ch14#id374)
  - 跟蹤行為資料, [隱私與追蹤](/tw/ch14#id373)
...
- 再平衡困難, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)-[運維：自動/手動再平衡](/tw/ch7#sec_sharding_operations), [術語表](/tw/glossary)
  - （另見 分片）
  - 自動或人工再平衡, [運維：自動/手動再平衡](/tw/ch7#sec_sharding_operations)
...
- 可擴展性, [可擴展性](/tw/ch2#sec_introduction_scalability)-[可擴展性原則](/tw/ch2#id35), [流式系統的哲學](/tw/ch13#ch_philosophy)
  - 自動縮放, [運維：自動/手動再平衡](/tw/ch7#sec_sharding_operations)
  - 透過磨損, [分片的利與弊](/tw/ch7#sec_sharding_reasons)
  - 描述負載, [描述負載](/tw/ch2#id33)
  - 描述效能, [描述效能](/tw/ch2#sec_introduction_percentiles)
  - 線性, [描述負載](/tw/ch2#id33)
  - 原則, [可擴展性原則](/tw/ch2#id35)
...
- 分片, [分片](/tw/ch7#ch_sharding)-[總結](/tw/ch7#summary), [術語表](/tw/glossary)
  ...
  - 鍵程分割, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)
  ...
  - 分割槽鍵, [分片的利與弊](/tw/ch7#sec_sharding_reasons), [鍵值資料的分片](/tw/ch7#sec_sharding_key_value)
  - 再平衡
    - 金鑰範圍壓縮資料, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)
  - 再平衡困難, [再平衡鍵範圍分片資料](/tw/ch7#rebalancing-key-range-sharded-data)-[運維：自動/手動再平衡](/tw/ch7#sec_sharding_operations)
    - 自動或人工再平衡, [運維：自動/手動再平衡](/tw/ch7#sec_sharding_operations)
    - Hash mod N的問題, [雜湊取模節點數](/tw/ch7#hash-modulo-number-of-nodes)
...
- 同步引擎, [同步引擎與本地優先軟體](/tw/ch6#sec_replication_offline_clients)-[同步引擎的利弊](/tw/ch6#pros-and-cons-of-sync-engines)
  ...
  - 用於本地第一軟體, [實時協作、離線優先和本地優先應用](/tw/ch6#real-time-collaboration-offline-first-and-local-first-apps)
