...
{{< fig num="13-1" id="fig_future_write_read_paths" src="/fig/ddia_1301.png" caption="In a search index, writes (document updates) meet reads (queries)." />}}
...
{{< fig num="13-2" id="fig_future_multi_shard" src="/fig/ddia_1302.png" caption="Checking whether a source account has enough money, and atomically transferring money to a destination account and a fees account, using event logs and stream processors." />}}
