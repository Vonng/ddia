...
{{< fig num="10-2" id="fig_consistency_linearizability_1" src="/fig/ddia_1002.png" caption="If a read request is concurrent with a write request, it may return either the old or the new value." />}}
