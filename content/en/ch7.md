...
{{< fig num="7-1" id="fig_sharding_replicas" src="/fig/ddia_0701.png" caption="Combining replication and sharding: each node acts as leader for some shards and follower for other shards." />}}
...
{{< fig num="7-2" id="fig_sharding_encyclopedia" src="/fig/ddia_0702.png" caption="A print encyclopedia is sharded by key range." />}}
...
{{< fig num="7-3" id="fig_sharding_hash_mod_n" src="/fig/ddia_0703.png" caption="Assigning keys to nodes by hashing the key and taking it modulo the number of nodes. Changing the number of nodes results in many keys moving from one node to another." />}}
...
{{< fig num="7-4" id="fig_sharding_rebalance_fixed" src="/fig/ddia_0704.png" caption="Adding a new node to a database cluster with multiple shards per node." />}}
...
{{< fig num="7-5" id="fig_sharding_hash_range" src="/fig/ddia_0705.png" caption="Assigning a contiguous range of hash values to each shard." />}}
...
{{< fig num="7-6" id="fig_sharding_cassandra" src="/fig/ddia_0706.png" caption="Cassandra and ScyllaDB split the range of possible hash values (here 0–1023) into contiguous ranges with random boundaries, and assign several ranges to each node." />}}
...
{{< fig num="7-7" id="fig_sharding_routing" src="/fig/ddia_0707.png" caption="Three different ways of routing a request to the right node." />}}
...
{{< fig num="7-8" id="fig_sharding_zookeeper" src="/fig/ddia_0708.png" caption="Using ZooKeeper to keep track of assignment of shards to nodes." />}}
...
{{< fig num="7-9" id="fig_sharding_local_secondary" src="/fig/ddia_0709.png" caption="Local secondary indexes: each shard indexes only the records within its own shard." />}}
...
{{< fig num="7-10" id="fig_sharding_global_secondary" src="/fig/ddia_0710.png" caption="A global secondary index reflects data from all shards, and is itself sharded by the indexed value." />}}
