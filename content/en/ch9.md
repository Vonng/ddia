...
{{< fig num="9-1" id="fig_distributed_network" src="/fig/ddia_0901.png" caption="If you send a request and don't get a response, it's not possible to distinguish whether (a) the request was lost, (b) the remote node is down, or (c) the response was lost." />}}
...
{{< fig num="9-2" id="fig_distributed_switch_queueing" src="/fig/ddia_0902.png" caption="If several machines send network traffic to the same destination, its switch queue can fill up. Here, ports 1, 2, and 4 are all trying to send packets to port 3." />}}
...
{{< fig num="9-3" id="fig_distributed_timestamps" src="/fig/ddia_0903.png" caption="The write by client B is causally later than the write by client A, but B's write has an earlier timestamp." />}}
...
{{< fig num="9-4" id="fig_distributed_lease_pause" src="/fig/ddia_0904.png" caption="Incorrect implementation of a distributed lock: client 1 believes that it still has a valid lease, even though it has expired, and thus corrupts a file in storage." />}}
...
{{< fig num="9-5" id="fig_distributed_lease_delay" src="/fig/ddia_0905.png" caption="A message from a former leaseholder might be delayed for a long time, and arrive after another node has taken over the lease." />}}
...
{{< fig num="9-6" id="fig_distributed_fencing" src="/fig/ddia_0906.png" caption="Making access to storage safe by allowing writes only in the order of increasing fencing tokens." />}}
...
{{< fig num="9-7" id="fig_distributed_fencing_leaderless" src="/fig/ddia_0907.png" caption="Using fencing tokens to protect writes to a leaderless replicated database." />}}
