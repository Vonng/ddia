...
{{< fig num="11-1" id="fig_batch_mapreduce" src="/fig/ddia_1101.png" caption="A MapReduce job with three mappers and three reducers." />}}
...
{{< fig num="11-2" id="fig_batch_join_example" src="/fig/ddia_1102.png" caption="A join between a log of user activity events and a database of user profiles." />}}
...
{{< fig num="11-3" id="fig_batch_join_reduce" src="/fig/ddia_1103.png" caption="A sort-merge join on user ID. If the input datasets are sharded into multiple files, each could be processed with multiple mappers in parallel." />}}
